...
// test_golden
double test_golden(double ax, double bx, double cx, double tol);
RcppExport SEXP _neogro_test_golden(SEXP axSEXP, SEXP bxSEXP, SEXP cxSEXP, SEXP tolSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(test_golden(ax, bx, cx, tol));
